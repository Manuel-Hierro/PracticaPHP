...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../app/assets/fontawesome/css/fontawesome.min.css">
    <link rel="stylesheet" type="text/css" href="../app/assets/css/estilos.css">
      ...
      <div class="card card-block">
        ...
        <form method="post">
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" name="servidor" value="<?php if(isset($_POST["servidor"])){ echo $_POST["servidor"];} ?>"></input>
            </div>
          </div>
          <div class="form-group row">
            <label for="usuario" class="col-md-3 col-form-label"><strong>Usuario</strong></label>
            <div class="col-md-9">
              <input class="form-control" type="text" name="usuario" value="<?php if(isset($_POST["usuario"])){ echo $_POST["usuario"];} ?>"></input>
            </div>
          </div>
          <div class="form-group row">
            <label for="password" class="col-md-3 col-form-label"><strong>Contraseña</strong></label>
            <div class="col-md-9">
              <input class="form-control" type="password" name="password" value="<?php if(isset($_POST["password"])){ echo $_POST["password"];} ?>">
            </div>
          </div>
          <div class="form-group row">
            <label for="basedatos" class="col-md-3 col-form-label"><strong>Base de datos</strong></label>
            <div class="col-md-9">
              <input class="form-control" type="text" name="basedatos" value="<?php if(isset($_POST["basedatos"])){ echo $_POST["basedatos"];} ?>"></input>
            </div>
          </div>
...
function creaBD() {
  ...
  $sql = $creabd . file_get_contents("db.sql");
  ...
  <div class="card card-block text-md-center col-md-6 offset-md-3">
    <h1>La Base de datos se ha creado correctamente</h1>
    <a href="../app/index.php" class="btn btn-primary">Acceder a la Aplicacion</a>
  </div> 
